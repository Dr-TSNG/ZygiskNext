export default {
    ...
    module: {
        issue: {
            ...
            linker_issue: 'فشل Zygisk Next في تحميل الوحدة {name} باستخدام الرابط المدمج. يرجى إبلاغ Zygisk Next بالمشكلة فقط إذا كانت الوحدة تُحمَّل بنجاح باستخدام رابط النظام.',
