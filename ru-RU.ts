export default {
    ...
    module: {
        issue: {
            ...
            linker_issue: 'Zygisk Next не удалось загрузить модуль {name} с помощью встроенного компоновщика. Сообщайте о проблеме в Zygisk Next только если модуль успешно загружается системным компоновщиком.',
