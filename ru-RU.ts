export default {
    ...
    settings: {
        ...
        zn_linker: 'Отключить линкер Zygisk Next',
        zn_linker_desc: 'Отключить встроенный линкер и использовать системный линкер для загрузки модулей. Это может снизить скрытность, но повысить совместимость.',
    },
    zygote_inject_state: {
        running: 'Запущен',
