export default {
    ...
    zygote_inject_state: {
        ...
        running_desc: 'Zygote 監察器正常運作。',
        stop_by_user_desc: 'Zygote 監察器被用戶停止。',
        stop_by_crash_desc: '偵測到 Zygote 反覆重啟，Zygote 監察器已自動關閉。',
    },
    zygote_state: {
        unknown: '未知',
        injected: '已注入 ({pid})',
        ...
        skipped: '已跳過 ({pid})',
        unknown_desc: '該 Zygote 狀態未知，可能存在但未啟動，或監察器未偵測到其啟動。',
