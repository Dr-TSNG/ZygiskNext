export default {
    ...
    settings: {
        ...
        zn_linker: 'Disable Zygisk Next linker',
        zn_linker_desc: 'Turn off the built-in linker and use the system linker to load modules. This may reduce stealth but improve compatibility.',
    },
    zygote_inject_state: {
        running: 'Running',
