export default {
    ...
    settings: {
        ...
        enforce_denylist_desc: 'Enforced: Mọi thay đổi đối với các ứng dụng trong Denylist sẽ bị hoàn tác.<br/>Umount Only: Chỉ các thay đổi liên quan đến Mount mới bị hoàn tác.',
