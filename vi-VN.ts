export default {
    ...
    settings: {
        ...
        zn_linker: 'Vô hiệu hóa trình liên kết Zygisk Next',
        zn_linker_desc: 'Tắt trình liên kết tích hợp và dùng trình liên kết hệ thống để nạp mô-đun. Việc này có thể giảm khả năng tàng hình nhưng cải thiện khả năng tương thích.',
    },
    zygote_inject_state: {
        running: 'Đang chạy',
