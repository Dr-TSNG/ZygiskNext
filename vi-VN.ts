export default {
    ...
    settings: {
        ...
        enforce_denylist_desc: 'Chế độ Enforced: mọi thay đổi đối với các ứng dụng trong denylist sẽ bị hoàn tác.<br/>Chỉ Umount: chỉ các thay đổi liên quan đến mount mới bị hoàn tác.',
