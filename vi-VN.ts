export default {
    ...
    bugreport: {
        export: 'Xuất Báo cáo lỗi',
        exporting: 'Đang xuất…',
        export_success_title: 'Đã xuất Báo cáo lỗi',
        export_success: 'Báo cáo lỗi đã được lưu tại:',
        export_failed_title: 'Xuất thất bại',
        export_failed: 'Không thể xuất Báo cáo lỗi.',
    ...
    module: {
        issue: {
            ...
            crash_issue: 'Module {name} này xuất hiện trong dấu vết lỗi ở luồng bị crash của: {processes}.',
