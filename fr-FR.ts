export default {
    ...
    settings: {
        ...
        zn_linker: 'Désactiver le linker Zygisk Next',
        zn_linker_desc: 'Désactiver le linker intégré et utiliser le linker système pour charger les modules. Cela peut réduire la furtivité mais améliorer la compatibilité.',
    },
    zygote_inject_state: {
        running: 'Actif',
